...
export default function MesServices() {
  ...
  const services = [
    {id: 1, description: t('service.web.description'), titre: t('service.web.title'), avatar: '../../public/Images/4.jpg', modal: startModal},
    {id: 2, description: t('service.analyse.description'), titre: t('service.analyse.title'), avatar: '../../public/Images/web.jfif', modal: startAnalyse},
    {id: 3, description: t('service.maintenance.description'), titre: t('service.maintenance.title'), avatar: '../../public/Images/maint2.jfif', modal: startMaintenance},
  ] 
  return (
